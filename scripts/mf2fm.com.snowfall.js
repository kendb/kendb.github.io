var speed = 1; // lower number for faster
var flakes = 100; // number of flakes
var colour = "#eff6ff"; // colour of flakes
var slush = 200; // set to '0' for no slush or otherwise set to height at which slush melts
